...
<html>
	...
	<body>
		...
		<div class="content">
			...
			<div class="content_data1">$ <fmt:formatNumber type="number" minFractionDigits="2" maxFractionDigits="2" value="${weekGoals.incomeGoal}" />
			</div>
		
			<div class="content_data">#Transactions Needed / 2013
			</div>
			<div class="content_data1"> <fmt:formatNumber type="number" minFractionDigits="0" maxFractionDigits="0" value="${weekGoals.transactionsNeeded}" />
			</div>
			
			<div class="content_data">Transactions Closed
			</div>
			<div class="content_data1"><fmt:formatNumber type="number" minFractionDigits="0" maxFractionDigits="0" value="${weekGoals.transactionsClosed}" />
			</div>
			
			<div class="content_data">Commission Earned (YTD)
			</div>
			<div class="content_data1">$ <fmt:formatNumber type="number" minFractionDigits="2" maxFractionDigits="2" value="${weekGoals.commissionEarned}" />
			</div>
			<div class="content_data">Transactions Needed (This week)
			</div>
			<div class="content_data1"><fmt:formatNumber type="number" minFractionDigits="0" maxFractionDigits="0" value="${weekGoals.weeklyTransaction}" />
			</div>
			<div class="content_data">Prospects Needed (This week)
			</div>
			<div class="content_data1"><fmt:formatNumber type="number" minFractionDigits="0"  maxFractionDigits="0" value="${weekGoals.weeklyProspectsRemained}" />
			</div>
			<!----- DESIGN----->
			<div class="design">
