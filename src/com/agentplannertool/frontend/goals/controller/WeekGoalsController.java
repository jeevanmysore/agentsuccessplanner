...
public class WeekGoalsController extends HttpServlet {
			...
			String username=session.getAttribute("username").toString();
				Calendar cal=Calendar.getInstance();
				 ...
				 if(goalsDto!=null){	
					 ...
					 request.setAttribute("weekGoals",goalsDto);
					 
					 
					 if(agent.equalsIgnoreCase("web")){
							
						 RequestDispatcher rd=request.getRequestDispatcher("/pages/weekGoals.jsp");
						 rd.forward(request, response);
					 }
					 else{
						 RequestDispatcher rd=request.getRequestDispatcher("/mobile/weekGoals.jsp");
						 rd.forward(request, response);
					 }
				 }		
