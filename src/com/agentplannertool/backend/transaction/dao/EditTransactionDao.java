...
public class EditTransactionDao {
	
	public TransactionDto getTransactionFromDB(Connection con,int id)throws Exception{
	...
	public String editTransactionToDB(Connection con,TransactionDto transDto)throws Exception{
		System.out.println("in dao");
		String insert_result="fail";
		String sql="UPDATE transactions set date=?,type=?,sales_price=?,comission_earned=? where id=?";
		PreparedStatement pstmt=con.prepareStatement(sql);
